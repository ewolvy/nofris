...
boolean initSensors (); // devolverá 0 si se han inicializado todos corrrectamente
void calibration ();
void testSensors ();
...
boolean scout (uint16_t timeLimit); // si no consigue llegar al goal en el tiempo establecido, devolverá un 1 si llega al goal, error 0 todo ok.
void run();
